package com.example.sitpass.utils;
...
public class TokenUtils {
    ...
    public String generateToken(Map<String, Object> claims) {
        return Jwts.builder()
                .setClaims(claims)
                .setIssuer(APP_NAME)
                .setAudience(generateAudience())//postoji razliciti tipovi uradjaja za koje se kreira token..
    ...
    private Date generateExpirationDate() {
        return new Date(new Date().getTime() + EXPIRES_IN);//stavili smo da 30 minuta vazi token
    }
